...
var (
	ddASCIIToEBCDIC [256]byte
	ddEBCDICToASCII [256]byte
)

func init() {
	ddASCIIToEBCDIC = ddASCIIToIBM
	ddASCIIToEBCDIC['^'] = 0x9a
	ddASCIIToEBCDIC['~'] = 0x5f
	ddASCIIToEBCDIC[0xcb] = 0x6a
	ddASCIIToEBCDIC[0xd5] = 0x4a
	ddASCIIToEBCDIC[0xe5] = 0xa1
	for i, b := range ddASCIIToEBCDIC {
		ddEBCDICToASCII[b] = byte(i)
	}
}
