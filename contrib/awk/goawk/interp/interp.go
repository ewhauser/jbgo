...
import (
	...
	"github.com/ewhauser/gbash/contrib/awk/goawk/internal/ast"
	"github.com/ewhauser/gbash/contrib/awk/goawk/internal/compiler"
	"github.com/ewhauser/gbash/contrib/awk/goawk/internal/resolver"
...
type Config struct {
	...
	//   filenames in Args when FileOpener is nil
	NoExec       bool
	NoFileWrites bool
	NoFileReads  bool

	// Optional hook for opening regular input files used by filenames in Args
	// and getline <file>. If nil, goawk falls back to os.Open subject to
	// NoFileReads.
