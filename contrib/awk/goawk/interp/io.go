...
import (
	...
	"github.com/ewhauser/gbash/contrib/awk/goawk/lexer"
)
...
func (p *interp) openInputFile(name string) (io.ReadCloser, error) {
	if p.fileOpener != nil {
		return p.fileOpener(name)
	}
	if p.noFileReads {
