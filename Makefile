...
lint:
	...
	cd contrib/awk && $(GOLANGCI_LINT) run ./...
	cd contrib/extras && $(GOLANGCI_LINT) run ./...
	cd contrib/htmltomarkdown && $(GOLANGCI_LINT) run ./...
	cd contrib/sqlite3 && $(GOLANGCI_LINT) run ./...
	cd contrib/yq && $(GOLANGCI_LINT) run ./...
	cd contrib/jq && $(GOLANGCI_LINT) run ./...

lint-new:
	$(GOLANGCI_LINT) run --new-from-rev=HEAD ./...
	cd examples && $(GOLANGCI_LINT) run --new-from-rev=HEAD ./...
	cd contrib/awk && $(GOLANGCI_LINT) run --new-from-rev=HEAD ./...
	cd contrib/extras && $(GOLANGCI_LINT) run --new-from-rev=HEAD ./...
	cd contrib/htmltomarkdown && $(GOLANGCI_LINT) run --new-from-rev=HEAD ./...
	cd contrib/sqlite3 && $(GOLANGCI_LINT) run --new-from-rev=HEAD ./...
	cd contrib/yq && $(GOLANGCI_LINT) run --new-from-rev=HEAD ./...
	cd contrib/jq && $(GOLANGCI_LINT) run --new-from-rev=HEAD ./...
