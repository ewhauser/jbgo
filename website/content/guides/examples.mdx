...
Uses the upstream AgentFS Go SDK as a custom `gbash` filesystem backend. Demonstrates how to persist sandbox filesystem state in an external SQLite-backed agent filesystem without changing `gbash`'s public embedding API.

[View on GitHub](https://github.com/ewhauser/gbash/tree/main/examples/agentfs-backed-fs)
