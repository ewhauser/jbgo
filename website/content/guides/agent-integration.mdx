...
- [agentfs-backed-fs](https://github.com/ewhauser/gbash/tree/main/examples/agentfs-backed-fs) - uses the AgentFS Go SDK as a persistent gbash filesystem backend
