...
import { Bash } from "@/app/lib/gbash-browser";
...
export default function TerminalComponent() {
  ...
  useEffect(() => {
    ...
    const files = {
      ...
      "/home/user/go.mod": getTerminalData("file-go-mod"),
      "/home/user/AGENTS.md": getTerminalData("file-agents-md"),
      "/home/user/cmd/gbash/version.go": getTerminalData("file-version-go"),
      "/home/user/examples/website/README.md": getTerminalData("file-website-readme"),
    ...
    requestAnimationFrame(() => {
      ...
      if (agentQuery) {
        ...
        inputHandler.setInitialCommand("pwd");
      }
    });
