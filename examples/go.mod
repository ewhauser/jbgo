...
require (
	...
	github.com/ewhauser/gbash/contrib/bashtool v0.0.30
	github.com/ewhauser/gbash/contrib/extras v0.0.30
...
require (
	...
	github.com/ewhauser/gbash/contrib/jq v0.0.30 // indirect
